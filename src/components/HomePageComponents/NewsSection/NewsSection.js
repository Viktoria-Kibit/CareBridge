          ...
          <div className="bg-gray-100 p-6 rounded-lg shadow-md flex flex-col">
            ...
            <div className="flex flex-col justify-between">
              ...
              <p className="text-gray-700 mb-4">
                ...
                тепла нашим хвостатим підопічним! Приходьте на прогулянку з
                собаками — це чудовий спосіб провести час, допомогти тваринам
                соціалізуватися та подарувати їм радість.
              </p>
              {isExpanded && (
                <p className="text-gray-700 mb-4">
